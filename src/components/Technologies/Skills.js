...
export const Skills = [
  ...
  // Backend Skills
  {
    ...
    title: 'Node.js',
    Description: () => (
      <>Build server-side applications with event-driven and non-blocking I/O model</>
    ),
  },
  {
    slug: 'nest.js',
  ...
  },
  {
    ...
    title: 'TRPC',
    Description: () => (
      <>Implement type-safe and efficient communication between client and server</>
    ),
  },
  {
    slug: 'webrtc',
  ...
  // Infrastructure Skills
  {
    ...
    title: 'Nginx',
    Description: () => (
      <>Utilize the high-performance web server, load balancer, and reverse proxy</>
    ),
  },
  {
    slug: 'docker',
